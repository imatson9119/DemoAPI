...
#pragma warning restore CS1591
        ...
        /// </summary>
        /// <param name="pageSize">Size of requested page</param>
        /// <param name="pageNumber">Desire page to retrieve</param>
        /// <returns>A response as update stock item result</returns>
        /// <response code="200">If the list was returned successfully</response>
        /// <response code="500">If there was an internal server error</response>
        [HttpGet("Product")]
        [ProducesResponseType(200)]
        [ProducesResponseType(500)]
